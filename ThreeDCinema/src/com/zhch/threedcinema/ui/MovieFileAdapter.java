...
public class MovieFileAdapter extends BaseAdapter{
	private LayoutInflater mInflater;
	  ...
	  public MovieFileAdapter(Context context,List<String> it,List<String> pa)
	  {
	  ...
	  public View getView(int position,View convertView,ViewGroup parent)
	  {
	    ...
	    if(convertView == null)
	    {
	      convertView = mInflater.inflate(R.layout.item_fileselect, null);
