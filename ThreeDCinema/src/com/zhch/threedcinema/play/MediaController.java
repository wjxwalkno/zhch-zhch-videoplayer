...
package com.zhch.threedcinema.play;
...
import com.zhch.threedcinema.play.CommonGestures.TouchListener;
import com.zhch.threedcinema.utils.DeviceUtils;
import com.zhch.threedcinema.utils.FractionalTouchDelegate;
...
public class MediaController extends FrameLayout {
	...
	private void findViewItems(View v) {
		...
		mThreeD=(ImageButton)v.findViewById(R.id.mediacontroller_threed);
	    
		mThreeD.setOnClickListener(mThreeDListener);
...
//@by wjx	
	private View.OnClickListener mThreeDListener = new View.OnClickListener() {
		@Override
		public void onClick(View v) {
			
			if(isThreeD&&(!isSourceD)&&(isTwoD)){
			  mThreeD.setImageResource(R.drawable.mediacotroller_sourced_bn);
      		  isThreeD=false;
      		  isTwoD=false;
      		  isSourceD=true;
      		  
			}else if(isSourceD&&(!isTwoD)&&(!isThreeD)){
			  mThreeD.setImageResource(R.drawable.mediacotroller_threed_bn);
      		  isThreeD=true;
      		  isTwoD=false;
      		  isSourceD=false;
      		 
			}else if(isThreeD&&(!isSourceD)&&(!isTwoD)){
				mThreeD.setImageResource(R.drawable.mediacotroller_twod_bn);				
	      		isTwoD=true;
			}
