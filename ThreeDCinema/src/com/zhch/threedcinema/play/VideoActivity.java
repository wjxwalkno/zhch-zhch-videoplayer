...
import com.zhch.threedcinema.preference.PreferenceUtils;
import com.zhch.threedcinema.utils.ApplicationUtils;
import com.zhch.threedcinema.utils.DeviceUtils;
import com.zhch.threedcinema.utils.ImageUtils;
import com.zhch.threedcinema.utils.IntentHelper;
import com.zhch.threedcinema.utils.MediaUtils;
import com.zhch.threedcinema.utils.StringUtils;
import com.zhch.threedcinema.utils.ToastUtils;
...
//	private S3DVSurface s3dvsurface;
	...
	private void attachMediaController() {
		...
		mMediaController.setSurfaceHolder(mVideoView.getHolder());
			...
			case OPEN_FILE:
				synchronized (mOpenLock) {
					if (!mOpened.get() && vPlayer != null) {
						...
						if (mVideoView != null)
							{
//								s3dvsurface = new S3DVSurface(mVideoView.getHolder());
//								s3dvsurface.SetV3DType(1, 3, 0);
	...
	public void snapshot() {
		if (!com.zhch.threedcinema.utils.FileUtils.sdAvailable()) {
